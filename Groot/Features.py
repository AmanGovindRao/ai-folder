...
def GoogleSearch(term):
    ...
    oooooo = open('P:\\JARVIS\\Groot\\Data.txt','a')
    ...
    os.startfile('P:\\JARVIS\\Groot\\DataBase\\ExtraPro\\start.py')
...
def Alarm(query):
    ...
    TimeHere=  open('P:\\JARVIS\\Groot\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    os.startfile("P:\\JARVIS\\Groot\\DataBase\\ExtraPro\\Alarm.py")
...
def DownloadYouTube():
    ...
    def Download(link):
        ...
        video.download('P:\\JARVIS\\FilesByGroot\\video Dowloaded\\')
    ...
    os.startfile('P:\\JARVIS\\FilesByGroot\\Youtube\\')

def SpeedTest():

    os.startfile("P:\\JARVIS\\Groot\\DataBase\\Gui Programs\\SpeedTestGui.py")
