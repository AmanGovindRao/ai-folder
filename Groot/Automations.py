...
def WhatsappMsg(name,message):
    ...
    startfile("C:\\Users\\amanr\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
...
def Notepad():
    ...
    path_1 = "P:\\JARVIS\\FilesByGroot\\Notes of jarvis\\" + str(filename)

    path_2 = "P:\\JARVIS\\Groot\\DataBase\\NotePad\\" + str(filename)
