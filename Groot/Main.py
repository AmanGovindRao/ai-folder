...
# engine.setProperty('rate',180)    #this line means speed of speaking of assistance (default rate-200)
...
def TaskExe():
    ...
    while True:
        ...
        elif 'corona cases' in query or 'corona news' in query or 'corona report' in query:
